...
# geometry
NUMCELLS = 400       # size of the (square) grid (NUMCELLS x NUMCELLS)
...
#Fertility: vegetob growth modifier
MAX_FERTILITY=1.5    #maximum multiplier
MIN_FERTILITY=0.5	 #minimum multiplier